...
const UpdateUserProfile = ({ route }) => {
    ...
    const fetchUserData = async () => {
      try {
        const response = await fetch(`http://192.168.1.2:8000/api/v1/users/user/${phoneNumber}`);
...
//         setUserData(prevData => ({
//             ...prevData,
//             profileImage: result.assets[0].uri, // Access the first asset's URI
//         }));
//     }
...
//                       source={
//                           userData.profileImage 
//                               ? { uri: encodeURI(userData.profileImage)}           // AWS image URL
//                               : require('../assets/images/logo-removebg-preview 1.png')    // Local fallback image
//                       }
//                       style={styles.image}
//                   />
