...
export default ({ navigation }) => {
    ...
    //         // Send OTP
    //         try {
    //             const response = await axios.post('http://192.168.1.8:8000/api/v1/users/sendOtp',
    //                  { 
    //                     phoneNumber,
    ...
    //     } else {
    //         // Verify OTP
    //         const response = await axios.post('http://192.168.1.8:8000/api/v1/users/verifyOtp', { otp, phoneNumber });
    ...
    const handleLogin = async () => {
        ...
        try {
            if (!isOtpSent) {
                ...
                // Verify OTP
                const response = await axios.post('http://192.168.1.8:8000/api/v1/users/verifyOtp', {
                    otp,
                    phoneNumber,
                });
