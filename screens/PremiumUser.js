...
const PremiumUser = ({ route }) => {
  ...
  //     const { data: { order } } = await axios.post("http://192.168.1.5:8005/api/v1/kgvmitra/kgvcheckout", { amount: amountInPaise });
  ...
  //       const verificationResponse = await axios.post("http://192.168.1.5:8005/api/v1/payment/premium/payment-verification", {
  //         ...data
  //       });
