...
import { SafeAreaView, Text, StyleSheet, View, Image, Keyboard, TextInput, TouchableOpacity } from 'react-native';
...
export default function TripDetails({ route }) {
    ...
    const handleSubmit = () => {
        socket.to(`user-${trip.user._id}`).emit('counterPrice', {
            name: user.fullName,
...
// import React, { useState, useEffect } from 'react';
// import { LinearGradient } from 'expo-linear-gradient';
// import { SafeAreaView, Text, StyleSheet, View, Image, Keyboard, TextInput } from 'react-native';
// import { KeyboardAwareScrollView } from 'react-native-keyboard-aware-scroll-view';
// export default function TripDetails({ route }) {
