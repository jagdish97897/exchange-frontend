...
export function Timesheet() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    try {
      const response = await fetch('http://192.168.1.14:8005/api/v1/timesheet/register', {
        method: 'POST',
    ...
    // const response = await fetch("http://192.168.1.14:8005/api/v1/timesheetregister", {
    //     method: "POST",
    //     body: form,
    // try {
    //   const response = await fetch("http://192.168.1.14:8005/api/v1/timesheetregister", {
  ...
  const handleSubmitManager = async (e) => {
    ...
    //   try {
    //     const response = await fetch('http://192.168.1.14:8005/api/v1/manager/rate',{
    //     method: 'POST',
